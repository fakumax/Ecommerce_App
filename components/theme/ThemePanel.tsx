        ...
        <>
          ...
          <aside className="fixed right-0 top-0 z-50 flex h-full w-full max-w-sm flex-col gap-6 overflow-y-auto bg-surface p-6 shadow-2xl">
            <div className="flex items-center justify-between">
              <h2 className="text-lg font-bold">Personalizar tienda</h2>
              <button onClick={() => setOpen(false)} aria-label="Cerrar" className="rounded-full p-2 text-soft hover:bg-bg">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round"><path d="M18 6 6 18M6 6l12 12" /></svg>
              </button>
            </div>

            <section>
              <h3 className="mb-3 text-sm font-semibold text-soft">Paletas</h3>
            ...
            <section>
              <h3 className="mb-3 text-sm font-semibold text-soft">Colores propios</h3>
            ...
            <section>
              <h3 className="mb-3 text-sm font-semibold text-soft">Tipografía</h3>
            ...
            <section>
              <h3 className="mb-3 text-sm font-semibold text-soft">Modo</h3>
